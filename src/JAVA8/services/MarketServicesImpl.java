...
public class MarketServicesImpl {
    ...
    public List<BakeryProducts> getAllBakeryProducts() {
        return this.bakeryProducts;
    }
    ...
    public List<ChildrenFood> getAllChildrenFoods() {
        return this.childrenFoods;
    }
    ...
    public List<SeaFood> getAllSeaFood() {
    ...
    public List<SportFood> getAllSport() {
        return this.sportFoods;
    }
